...
(1, 'Türkiye', 'Istanbul', 'Yılmaz Caddesi', 34000),
(2, 'Türkiye', 'Malatya', 'Aslaner Caddesi', 44000),
(3, 'Türkiye', 'Konya', 'Kocasahin Caddesi', 42000),
(4, 'Türkiye', 'Giresun', 'Yenice Caddesi', 28000),
(5, 'Türkiye', 'Istanbul', 'Madenler Caddesi', 34000);

INSERT INTO Customer (CustomerID, FName, LName, PhoneNum, AddressID) VALUES
(1, 'Mehmet', 'Yılmaz', '05547319220', 1),
(2, 'Eren', 'Yenice', '05396244134', 2),
(3, 'Ömer', 'Aslaner', '05558918643', 3),
...
(1, 1, 'Para Yatýrma', 5000, '2025-01-10', 'Yatýrým amaçlı para yatırıldı'),
(2, 2, 'Para Çekme', 1000, '2025-01-12', 'Ödeme için para çekildi'),
(3, 3, 'Para Yatýrma', 2000, '2025-01-13', 'Kampanya için ek yatırıldı'),
(4, 4, 'Para Çekme', 3000, '2025-01-14', 'Acil nakit çekim'),
(5, 5, 'Para Yatýrma', 10000, '2025-01-15', 'Yüksek faizli mevduat yatırıldı');
